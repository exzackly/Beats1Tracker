...
<?php require 'header.php'; ?>
	...
	<body>
		...
		<script>$("#nowPlaying").addClass("active");</script>
        ...
        <div id="section2">
            <h2 class="resizer" style="margin-bottom:padding-top:50px;">NOW PLAYING</h2>
            <br>
            <?php
				require_once("dbconn.php");

				$sql = "SELECT id, title, artist, album, artwork, playCount FROM Songs ORDER BY reg_date DESC LIMIT 10";
				$resultArray = array();
        ...
        <div id="section3">
            <h2 class="resizer" style="margin-bottom:padding-top:50px;">PLAY HISTORY</h2>
			<?php
